...
describe('HistoryComponent', () => {
  let component: PickemHistoryComponent;
  let fixture: ComponentFixture<PickemHistoryComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PickemHistoryComponent);
  ...
  describe('refreshHistories', () => {
    it('should throw an error if the user is not logged in when this method is called', () => {
      ...
      expect(() => component.refreshHistories()).toThrowError(
    ...
    it('should get the histories for a given user', () => {
      ...
      spyOn(lolPickEmService, 'getUserHistories').and.returnValue(
        of(userHistory),
      );
